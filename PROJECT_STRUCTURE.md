...
### 主要节点
1. **NakuNode-QWen3VL (简单)** → `qwen3vl_node.py:Qwen3VL_Simple`
2. **NakuNode-QWen3VL (高级)** → `qwen3vl_node.py:Qwen3VL_Advanced`

### 批量处理节点
3. **NakuNode-QWen3VL批量打标** → `qwen3vl_batch_caption.py:Qwen3VL_Batch_Caption`
4. **NakuNode-QWen3VL对比打标** → `qwen3vl_compare_caption.py:Qwen3VL_Compare_Caption`

### 配置节点
5. **NakuNode-QWen3VL额外选项** → `qwen3vl_extra_options.py:Qwen3VL_ExtraOptions`
